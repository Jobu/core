...
(
	...
	(
		'__selector__'                => array(''),
        'default'                     => '{general_legend},team_id,tournament_id,state_id,points;'
	),
	...
	(
        ...
        'state_id' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_beachcup_registration']['state_id'],
            'exclude'                 => true,
            'sorting'                 => true,
            'search'                  => true,
            'inputType'               => 'select',
            'foreignKey'              => 'tl_beachcup_registration_state.code',
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
            'sql'                     => "int(10) unsigned NOT NULL"
        ),
        'points' => array
