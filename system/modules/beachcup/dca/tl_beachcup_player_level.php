...
/**
 * Table tl_beachcup_player_level
 */
$GLOBALS['TL_DCA']['tl_beachcup_player_level'] = array
(
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_beachcup_player_level']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_beachcup_player_level']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_beachcup_player_level']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_beachcup_player_level']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	(
		...
		'code' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_beachcup_player_level']['code'],
			'exclude'                 => true,
            'sorting'                 => true,
            'search'                  => true,
			'inputType'               => 'text',
